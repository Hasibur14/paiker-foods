        ...
        < footer className="px-4 divide-y bg-primary-deep  text-gray-100 " >
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3 space-y-3">
                    <Link to='/'>
                        <h2 className="text-5xl font-extrabold font-shadows bg-gradient-to-t from-second-light to-second-deep text-transparent bg-clip-text">Paiker Foods</h2>
                    </Link>
                    <p className='w-full lg:w-2/3'>Happen active county. Winding morning
                        ambition shyness evident to poor. Because
                        elderly new to the point to main success.</p>
                </div>
